...
class FacilityRepository extends ChangeNotifier {
  ...
  void _loadInitialFacilities() {
    ...
    _facilities = [
      ...
      const FacilityDto(
        id: 'FAC-SC-103',
        name: 'Rampur Sub-Centre (रामपूर उप-केंद्र)',
        type: 'SUB_CENTRE',
        distanceKm: 3.5,
        address: 'Gram Panchayat Road, Rampur Village',
        contactPhone: '+91 2112 245002',
        totalBeds: 2,
        availableBeds: 2,
        onDutySpecialists: ['Community Health Officer (CHO)'],
        availableBloodUnits: {},
        availableDiagnostics: ['Rapid Blood Sugar', 'Urine Albumin'],
        availableMedicines: ['Paracetamol', 'Iron & Folic Acid', 'ORS'],
        hasEmergencyCapability: false,
        hasAmbulanceAvailable: false,
      ),
      const FacilityDto(
        id: 'FAC-SC-104',
        name: 'Kalyanpur Sub-Centre (कल्याणपूर उप-केंद्र)',
        type: 'SUB_CENTRE',
        distanceKm: 5.8,
        address: 'Near Primary School, Kalyanpur',
        contactPhone: '+91 2112 245003',
        totalBeds: 2,
        availableBeds: 1,
        onDutySpecialists: ['Community Health Officer (CHO)'],
        availableBloodUnits: {},
        availableDiagnostics: ['Rapid Blood Sugar', 'Rapid Malaria'],
        availableMedicines: ['Paracetamol', 'ORS'],
        hasEmergencyCapability: false,
        hasAmbulanceAvailable: false,
      ),
      const FacilityDto(
        id: 'FAC-SC-105',
        name: 'Shirur Rural Sub-Centre (शिरूर ग्रामीण उप-केंद्र)',
        type: 'SUB_CENTRE',
        distanceKm: 7.2,
        address: 'Old Pune Road, Shirur Rural',
        contactPhone: '+91 2112 245004',
        totalBeds: 2,
        availableBeds: 1,
        onDutySpecialists: ['Community Health Officer (CHO)'],
        availableBloodUnits: {},
        availableDiagnostics: ['Rapid Blood Sugar', 'Urine Albumin'],
        availableMedicines: ['Paracetamol', 'Iron & Folic Acid'],
        hasEmergencyCapability: false,
        hasAmbulanceAvailable: false,
      ),
      const FacilityDto(
        id: 'FAC-SC-106',
        name: 'Daund Sub-Centre (दौंड उप-केंद्र)',
        type: 'SUB_CENTRE',
        distanceKm: 8.5,
        address: 'Bypass Road, Daund Sub-Centre',
        contactPhone: '+91 2112 245005',
        totalBeds: 2,
        availableBeds: 2,
        onDutySpecialists: ['Community Health Officer (CHO)'],
        availableBloodUnits: {},
